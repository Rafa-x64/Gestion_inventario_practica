                ...
                <div class="col-11 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center py-3 mb-5">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-12 pt-3">
                                    <input type="text" name="fecha_registro" id="fecha_registro" value="<?php echo registroEmpresaC::obtener_feha_registro(); ?>" class="form-control" read>
                                </div>
                            </div>
                            <!--estado o condicion-->
                            <div class="row">
...
<script>
    ...
    document.cookie = "registro_hora=" + encodeURIComponent(ahora.toISOString()) + "; max-age=600; path=/";
</script>
<!--
