            ...
            <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center py-3 mb-5">
                ...
                <div class="row">
                    ...
                    <div class="col-6 pb-3">
                        <div class="row">
                            <div class="col-12">
                                <label for="empleado_cedula" class="form-label">Fecha de nacimiento</label>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="col-6 pb-3">
                        <div class="row">
                            <div class="col-12">
                                <label for="empleado_sexo" class="form-label">Fecha de nacimiento</label>
                            </div>
                            <div class="col-12">
                                <input type="te" name="empleado_fecha_nacimiento" id="empleado_fecha_nacimiento" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-6 pb-3">
