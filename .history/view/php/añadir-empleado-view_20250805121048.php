                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_fecha_registro" id="empleado_fecha_registro" class="form-control" value="" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    document.cookie = "empleado_fecha_ingreso=" + encodeURIComponent(empleado_fecha_ingreso) + "; max-age=600; path=/";
</script>
