                        ...
                        <div class="col-12 pb-3">
                            <div class="row">
                                ...
                                <div class="col-11 pb-3">
                                    <input type="text" name="empleado_nombre" id="empleado_nombre" placeholder="Nombre completo del empleado" class="form-control" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ][a-zA-ZÁÉÍÓÚáéíóúÑñ\s'-]{1,}\s[A-Za-zÁÉÍÓÚáéíóúÑñ][a-zA-ZÁÉÍÓÚáéíóúÑñ\s'-]{1,}" required title="Introduce un nombre completo válido, incluyendo acentos." val>
                                </div>
                            </div>
                        </div>
