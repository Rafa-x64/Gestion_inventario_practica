    ...
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-4 mb-5">
                <div class="row">
                    <div class="col-12">
                        <small class="form-text text-muted">Puedes seleccionar múltiples beneficios usando Ctrl o Shift.</small><small class="form-text text-muted">Puedes seleccionar múltiples beneficios usando Ctrl o Shift.</small>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_banco" id="empleado_banco" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_numero_cuenta" id="empleado_numero_cuenta" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 pb-3">
