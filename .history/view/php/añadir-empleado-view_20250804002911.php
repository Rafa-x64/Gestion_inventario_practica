...
<div class="contrainer-fluid">
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-start py-4 px-4 mb-5">
                <div class="row">
                    <div class="col-12">
                        <h4>Informacion personal</h4>
                    </div>
                </div>
                <section class="row mt-2" id="informacion_personal">
