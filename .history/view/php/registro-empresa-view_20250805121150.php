                        ...
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-12 text-center pt-3">
                                    <label for="fecha_registro">Tipo de usuario</label>
                                </div>
                                <div class="col-12 pt-3">
                                    <input type="text" name="ROL" id="ROL" value="super administrador" class="form-control" readonly>
                                </div>
                            </div>
                            <!--usuario admin-->
                            <div class="row">
...
<script>
    ...
    document.cookie = "registro_hora=" + encodeURIComponent(soloFecha) + "; path=/";
</script>
<!--envio del formulario-->
<?php
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (registroEmpresaC::obtener_formulario($_POST, $_FILES) == true) {
?>
        <div class="container-fluid">
            <div class="row d-flex flex-row align-items-center justify-content-center">
    ...
    <?php
        ...
        include("./controller/logout/cerrarSesion.php");
