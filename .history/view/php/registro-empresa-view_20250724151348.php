...
?>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 bg-success d-flex flex row align-items-center justify-content-center">
                    <p class="text-center">Empresa registrada correctamente. Redirigiendo a inicio de sesion</p>
                </div>
            </div>
        </div>
    <?php
        sleep(4);
        header("Location: index.php?page=inicio-sesion");
        ob_end_flush();
    }
} else {
    ?>
