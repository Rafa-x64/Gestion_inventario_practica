...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (inicioSesionC::validar_usuario($datos_usuario["nombre_legal"], $datos_usuario["usuario"], $datos_usuario["contraseña"]) == false) {
...
?>
        ...
        <meta http-equiv="refresh" content="4;url=index.php?page=inicio_sesion">
<?php

    }else if(inicioSesionC::validar_usuario($datos_usuario["nombre_legal"], $datos_usuario["usuario"], $datos_usuario["contraseña"]) == false && $datos_usuario["contraseña"]){}
