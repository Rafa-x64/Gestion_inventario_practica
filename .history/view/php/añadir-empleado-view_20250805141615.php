                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    <input type="number" name="empleado_bonificaciones" id="empleado_bonificaciones" class="form-control" placeholder="Ej. 150.00<?php echo crudEmpleadoC::obtener_moneda() ?>" step="0.50" min="0">
                                </div>
                                <div class="col-1 d-flex flex-column justify-content-center align-items-center">
                                    <p class="form-text mb-0"><?php echo crudEmpleadoC::obtener_moneda(); ?></p>
                                </div>
