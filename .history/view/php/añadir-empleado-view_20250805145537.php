                ...
                <section class="container-fluid pt-3">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="number" name="empleado_bonificaciones" id="empleado_deduccion" class="form-control" placeholder="Ej. 150.00<?php echo crudEmpleadoC::obtener_moneda() ?>" step="0.25" min="0">
                        </div>
                    </div>
                </section>
            </form>
