                ...
                <div class="col-12 col-md-10 col-lg-11 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center py-3 mb-5">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <input type="text" name="nombre_legal" id="nombre_legal" placeholder="Nombre legal de la empresa" class="form-control">
                                </div>
                            </div>
                            <!--prefijo y rif-->
                            <div class="row d-flex flex-row align-items-center justify-content-center">
                        ...
                        <!--botones-->
                        <div class="row">
                            <div class="col-sm-12 col-lg-6 pt-4 d-flex flex-row align-items-center justify-content-center">
                                <input type="submit" value="Registrar empresa" class="btn btn-success text-white">
                            </div>
                            <div class="col-sm-12 col-md- col-lg-6 pt-4 d-flex flex-row align-items-center justify-content-center">
