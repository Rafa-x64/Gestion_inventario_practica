...
<div class="contrainer-fluid">
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-sm-11 col-lg-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-sm-1 py-lg-4 px-4 mb-5" id="registro_empleado">
                <div class="row">
                ...
                <section class="container-fluid py-sm-1 py-lg-3" id="informacion_personal">
                    <div class="row">
                        <div class="col-12 pb-3">
                            <div class="row">
