                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_banco" id="empleado_banco" class="form-control" pattern="[A-Za-zÀ-ÿ\s]+" title="Ingrese el nombre del banco (puede incluir acentos y espacios)"
                                        required value="Banesco">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
