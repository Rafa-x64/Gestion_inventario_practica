...
?>
    ...
    ?>
    div.container-fluid>div.row>div.col-12.bg-.d-flex.flex.row.align-items-center.justify-content-center>p.text-center{Error al registrar la empresa. Redirigiendo a inicio}
<?php
}
?>