...
<div class="contrainer-fluid">
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-sm-11 col-lg-8 d-flex flex-column justify-content-center align-items-center pe-0">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-sm-1 px-md-3 px-lg-4 mb-5" id="registro_empleado">
                <div class="row">
