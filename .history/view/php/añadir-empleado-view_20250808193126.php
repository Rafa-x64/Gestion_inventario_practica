                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="password" name="empleado_contraseña" id="empleado_contraseña" class="form-control" value="Prueba123"
pattern="(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}"
title="Debe tener al menos 8 caracteres, incluyendo letras y números"
required>
                                </div>
                            </div>
                        </div>
