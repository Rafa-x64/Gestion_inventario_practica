                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="password" name="empleado_contraseña" id="empleado_contraseña" class="form-control" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$"
title="La contraseña debe tener al menos 8 caracteres, incluir mayúsculas, minúsculas, números y un carácter especial"
required value="Contraseña1!">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
