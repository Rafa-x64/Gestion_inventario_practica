                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_supervisor" id="empleado_supervisor" class="disabled form-control" value="<?php echo crudEmpleadoC::obtener_supervisor(); ?>" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-2">
                                            <label for="empleado_hora_entrada" class="form-label">Entrada</label>
                                        </div>
                                        <div class="col-4">
                                            <input type="time" name="empleado_hora_entrada" id="" class="form-control" required>
                                        </div>
                                        <div class="col-2">
                                            <label for="empleado_hora_salida" class="form-label">Salida</label>
                                        </div>
                                        <div class="col-4">
