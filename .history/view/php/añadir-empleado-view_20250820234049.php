                    ...
                    <div class="row">
                        ...
                        <div class="col-12 pb-3">
                            <div class="row">
                                ...
                                <div class="col-11 pb-3">
                                    <input type="text" name="empleado_nombre" id="empleado_nombre" placeholder="Nombre completo del empleado" class="form-control" pattern="[A-Za-zÁÉÍÓÚáéíóúÑñ][a-zA-ZÁÉÍÓÚáéíóúÑñ\s'-]{1,}\s[A-Za-zÁÉÍÓÚáéíóúÑñ][a-zA-ZÁÉÍÓÚáéíóúÑñ\s'-]{1,}" required title="Introduce un nombre completo válido, incluyendo acentos.">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_cedula" id="empleado_cedula" class="form-control" placeholder="ejemplo: 12.345.678" pattern="\d{2}\.\d{3}\.\d{3}" required title="Introduce un número de cédula en el formato correcto (ejemplo: 12.345.678).">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="text-danger px-1" id="punto-transparente">&bull;</p>
                                </div>
                                <div class="col-12">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                <div class="col-12 d-flex flex-row">
                                    ...
                                    <p class="text-danger px-1" id="punto-transparente"></p>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_banco" id="empleado_banco" class="form-control" pattern="[A-Za-zÀ-ÿ\s]+" title="Ingrese el nombre del banco (puede incluir acentos y espacios)" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_numero_cuenta" id="empleado_numero_cuenta" class="form-control" pattern="[A-Za-z0-9]{10,34}" required placeholder="Ej: ES9121000418450200051332 o 1234567890">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 pb-3">
                    ...
                    <div class="row">
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_usuario" id="empleado_usuario" class="form-control" placeholder="nombre_usuario123" pattern="^[a-zA-Z0-9_]+$" title="El nombre de usuario solo puede contener letras, números y guiones bajos" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="password" name="empleado_contraseña" id="empleado_contraseña" class="form-control" pattern="(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}" title="Debe tener al menos 8 caracteres, incluyendo letras y números" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="password" name="empleado_contraseña2" id="empleado_contraseña2" class="form-control" pattern="(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}" title="Debe tener al menos 8 caracteres, incluyendo letras y números" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
