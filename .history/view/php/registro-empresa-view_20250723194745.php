        ...
        <div class="col-8 align-items-center justify-content-center">
            <div class="row d-flex flex-column justify-content-center align-items-center">
                ...
                <div class="col-11 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center pb-3">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            <div class="col-12 d-flex flex-column align-items-center justify-content-center pt-4">
                                <div class="row">
                                    <div class="col-12">
                                        <input type="text" name="nombre_legal" id="nombre_legal" placeholder="Nombre legal" class="form">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 d-flex flex-row align-items-center justify-content-center pt-3">
                                ...
                                <div class="row">
                                    <div class="col-12 pt-3">
                                        <input type="tel" name="contacto" id="contacto" placeholder="Telefono de contacto">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 pt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 d-flex flex-column align-items-center justify-content-center">
                                        <input type="text" name="zona_horaria" id="zona_horaria" value="<?php echo registroEmpresaC::obtener_zona_horaria(); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
