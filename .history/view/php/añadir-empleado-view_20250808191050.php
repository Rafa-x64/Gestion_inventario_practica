                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_numero_cuenta" id="empleado_numero_cuenta" class="form-control" pattern="[A-Za-z0-9]{10,34}" requiredplaceholder="Ej: ES9121000418450200051332 o 1234567890">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 pb-3">
