            ...
            <div class="row">
                ...
                <div class="col-11 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="" method="post">
                        (input:text#nombre_legal[placeholder="Nombre legal"])+(select>option*6)+(input:text#rif[placeholder="RIF"])+Se usa el algoritmo Módulo 11, que toma los primeros 9 caracteres y les aplica una fórmula ponderada. El resultado final es el dígito verificador que valida el número completo.
                    </form>
                </div>
            </div>
        </div>
