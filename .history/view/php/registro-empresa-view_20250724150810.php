...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (registroEmpresaC::obtener_formulario($_POST, $_FILES)) {
?>
        div.container-fluid>div.row>div.col-12.bg-success.d-flex.flex.row.align-items-center.justify-content-center>p.text-center{Empresa registrada correctamente. Redirigiendo a inicio de sesion}
    <?php
    }
} else {
    ?>
    div.container-fluid>div.row>div.col-12.bg-success.d-flex.flex.row.align-items-center.justify-content-center>p.text-center{Empresa registrada correctamente. Redirigiendo a inicio de ses}
<?php
}
?>