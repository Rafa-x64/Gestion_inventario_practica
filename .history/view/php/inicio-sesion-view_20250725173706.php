                    ...
                    <form action="" method="post" id="formulario_empresa" class="form-control d-flex flex-column align-items-center justify-content-center py-3 mb-5" enctype="multipart/form-data">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            ...
                            <div class="row d-flex flex-row align-items-center justify-content-center">
                                ...
                                <div class="col-sm-10 col-md-4 col-lg-4 pt-4 d-flex flex-lg-row flex-row align-items-sm-center justify-content-sm-center align-items-lg-center justify-content-lg-start">
