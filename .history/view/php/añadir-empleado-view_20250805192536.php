                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <select name="empleado_tipo_deduccion" id="empleado_tipo_deduccion" class="form-select">
                                        ...
                                        <option value="seguridad_social">Seguridad Social – Aporte obligatorio al IVSS o sistemas de salud</option>
                                        <option value="fondo_salud">Fondo de salud – Descuentos para seguros médicos privados</option>
                                        <option value="parafiscales">Parafiscales – INCES, RPE y otros aportes obligatorios</option>
                                        <option value="caja_ahorro">Caja de ahorro – Retención voluntaria para ahorros colectivos</option>
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_banco" id="empleado_banco">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_numero_cuenta" id="empleado_numero_cuenta">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <select id="empleado_beneficios" class="form-select" name="beneficios[]"
                                        multiple>
                                        <option value="seguro_medico">Seguro médico</option>
                                        <option value="bono_alimentacion">Bono alimentación</option>
