...
?>
    div.container-fluid>div.row>div.col-12.bg-success.d-flex.flex.row.align-items-center.justify-content-center>p.text-center{empresa registrada correctamente. Redirig}
    <?php
    }
} else {
    ?>
