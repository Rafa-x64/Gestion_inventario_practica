    ...
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-4 mb-5">
                ...
                <section class="row pt-3" id="informacion_personal">
                ...
                <div class="row">
                    <div class="col-12">
                        <h5>Informacion laboral aaaaaaaaaaaaaaaaaaaaaaaaa</h5>
                    </div>
                </div>
                <section class="row pt-3" id="informacion_laboral">
                    <div class="col-12 pb-3">
                        <div class="row">
                            <div class="col-12">
                                <label for="empleado_rol" class="form-label">Cargo</label>
                            </div>
                            <div class="col-12 pb-3">
                                <select name="empleado_rol" id="empleado_rol" class="form-select">
