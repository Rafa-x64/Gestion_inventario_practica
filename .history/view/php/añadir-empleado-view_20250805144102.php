    ...
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-4 mb-5">
                <div class="row">
                    <div class="col-12">
                        <i class="bi bi-file-earmark-person fs-1 d-flex flex-row justify-content-end align-items-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <i class="bi bi bi-list-columns-reverse fs-1 d-flex flex-row justify-content-end align-items-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <i class="bi bi-wallet2 fs-1 d-flex flex-row justify-content-end align-items-center">
