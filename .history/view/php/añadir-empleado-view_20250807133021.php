            ...
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-4 mb-5" id="registro_empleado">
                <div class="row">
                    <div class="col-12 pb-3">
                        <small class="form-text text-muted d-flex flex-row">"Las casillas marcadas con <p class="text-danger px-1" id="punto-rojo">" &bull; "</p> son campos obligatorios".</small>
                    </div>
                </div>
                <div class="row">
                    <div class="col-2">
