                    ...
                    <div class="row">
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="empleado_salario" id="empleado_salario">
                                </div>
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                <div class="col-12">
                                    <label for="empleado_bonificaciones" class="form">Bonificaciones</label>
                                </div>
                                <div class="col-12">
                                    <input type="number" name="empleado_bonificaciones" id="empleado_bonificaciones" class="form-control" placeholder="Ej. 150.00" step="0.01" min="0">
                                </div>
                            </div>
                        </div>
                    </div>
