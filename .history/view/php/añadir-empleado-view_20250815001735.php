                    ...
                    <div class="row">
                        ...
                        <div class="col-12 pb-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input type="number" name="empleado_deduccion_mon" id="empleado_deduccion_monto" class="form-control" placeholder="Ej. 150.00<?php echo crudEmpleadoC::obtener_moneda() ?>" step="0.25" min="0">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
