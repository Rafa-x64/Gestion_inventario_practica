                    ...
                    <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            <div class="col-12 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <input type="mail" id="correo" placeholder="Correo electronico">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <input type="text" name="nombre" id="nombre_representante" placeholder="Nombre del representante">
                                    </div>
                                </div>
                                <input type="text" name="" id="fecha_registro" placeholder="Fecha de registro">
                                <div class="row">
                                    <div class="col-12 text-center">
