    ...
    <div class="row d-flex flex-column justify-content-center align-items-center my-4">
        ...
        <div class="col-8 d-flex flex-column justify-content-center align-items-center">
            <form action="" method="post" class="form-control d-flex flex-column align-items-start justify-content-center py-4 px-4 mb-5">
                ...
                <div class="row">
                    <div class="col-12">
                        <h5>Metrica salarial y beneficios</h5>
                    </div>
                </div>
                <section class="container-fluid pt-3" id="metrica_salarial">
                    <div class="row">
                        <div class="col-6 pb-3">
                            <div class="row">
                                <div class="col-12">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    <input type="number" name="empleado_bonificaciones" id="empleado_bonificaciones" class="form-control" placeholder="Ej. 150.00<?php echo crudEmpleadoC::obtener_moneda() ?>" step="0.01" min="0">
                                </div>
                                <div class="col-1 d-flex flex-column justify-content-center align-items-center">
                                    <p class="form-text mb-0"><?php echo crudEmpleadoC::obtener_moneda(); ?></p>
                                </div>
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                <div class="col-12">
                                    <label for="empleado_motivos" class="form-label">Bonificaciones</label>
                                </div>
                                <div class="col-11">
                                    <input type="number" name="empleado_motivos" id="empleado_bonificaciones" class="form-control" placeholder="Ej. 150.00<?php echo crudEmpleadoC::obtener_moneda() ?>" step="0.01" min="0">
                                </div>
                                <div class="col-1 d-flex flex-column justify-content-center align-items-center">
                                    <p class="form-text mb-0"><?php echo crudEmpleadoC::obtener_moneda(); ?></p>
                                </div>
