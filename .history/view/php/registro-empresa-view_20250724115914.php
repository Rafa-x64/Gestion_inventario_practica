...
?>
    <div class="container-fluid">
        <div class="col-12">
            <h3>los datos del formualrio son validos?</h3>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <form action="" method="get" class="form-control pt-3">
                    <div class="row">
                        <div class="col-12"><label for="valido_si">Si</label></div>
                        <div class="col-12"></div>
                    </div>

                    <input type="checkbox" name="valido" id="valido_si" value="si">
                    <label for="valido_no">No</label>
                    <input type="checkbox" name="valido" id="valido_no" value="no">
