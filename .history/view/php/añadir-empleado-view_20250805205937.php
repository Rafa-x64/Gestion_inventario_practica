                    ...
                    <div class="row">
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-11">
                                    <input type="number" class="form-control" name="empleado_salario" id="empleado_salario" placeholder="Ej. 1500.00<?php echo crudEmpleadoC::obtener_moneda() ?>" min="0"  required>
                                </div>
