                ...
                <section class="container-fluid pt-3" id="informacion_personal">
                    <div class="row">
                        ...
                        <div class="col-12 pb-3">
                            <div class="row">
                                <div class="col-12">
                                    <label for="empleado_horario" class="form-label">Horario laboral</label>
                                </div>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-2">
                                        ...
                                        <div class="col-2">
                                            <input type="number" name="" id="" step="1" class="form-control">
                                        </div>
                                        <div class="col-2">
                                            <select name="ejemplo" id="" class="form-select">
                                        ...
                                        <div class="col-2">
                                            <input type="number" name="" id="" min="00" step="1" max="12" class="form-control">
                                        </div>
                                        <div class="col-2">
