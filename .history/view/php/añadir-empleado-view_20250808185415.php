                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="tel" name="empleado_telefono" id="empleado_telefono" class="form-control" placeholder="ejemplo: -xxx-xxxx o +xx-xxx-xxx-xxxx" pattern="^(\+\d{2}-\d{3}-\d{3}|\d{4}-\d{3}-\d{4})$" required title="Introduce un número de teléfono válido: xxxx-xxx-xxxx o +xx-xxx-xxx-xxxx.">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
