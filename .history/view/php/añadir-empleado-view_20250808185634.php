                    ...
                    <div class="row">
                        ...
                        <div class="col-6 pb-3">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" name="empleado_cedula" id="empleado_cedula" class="form-control" placeholder="ejemplo: 12.345.678" pattern="\d{2}\.\d{3}\.\d{3}" required title="Introduce un número de cédula en el formato correcto (ejemplo: 12.345.678)." value="31.">
                                </div>
                            </div>
                        </div>
                        <div class="col-6 pb-3">
