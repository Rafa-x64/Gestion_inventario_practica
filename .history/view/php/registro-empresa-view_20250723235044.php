                ...
                <div class="col-12 col-md-10 col-lg-11 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="" method="post" class="form-control d-flex flex-column align-items-center justify-content-center py-3 mb-5">
                        <div class="row d-flex flex-row align-items-center justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-12 pt-3">
                                    <input type="text" name="nombre_representante" id="nombre_representante" class="form-control" placeholder="Nombre del representante" pattern="[A-Za-zÀ-ÿñÑ\s'\-]{2,100}" title="Solo letras, espacios, apóstrofos o guiones. Mínimo 2 caracteres." >
                                </div>
                            </div>
                            <!--fecha de registro-->
                            <div class="row">
