...
<header class="container-fluid" id="menu-superior">
    <div class="row bg-primary py-3 d-flex flex-row justify-content-between align-items-center">
        ...
        <div class="col-3 col-md-2 col-lg-1 d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="menu-izquierdo">
                ...
                <div class="offcanvas-body">
                    <div class="row">
                        <div class="col-lg-12 ps-lg-4 py-2 my-2 rounded">
                            <!--volver al dashboard-->
                            <div class="row d-flex flex-row mb-3">
                                <div
                                    class="col-2 px-0 d-flex flex-row justify-content-center align-items-center">
                                    <i class="bi bi-house fs-3"></i>
                                </div>
                                <div
                                    class="col-10 ps-2 d-flex flex-row justify-content-start align-items-center">
                                    <a href="index.php?page=dashboard-admin" style="color:black">volver al Dashboard</a>
                                </div>
                            </div>
                            <!-- Sección: Productos -->
                                ...
                                <ul id="lista-opciones-menu-izquierdo">
                                    ...
                                    <li class="pt-2">
                                        <div class="row d-flex flex-row">
                                            ...
                                            <div
                                                class="col-11 px-0 d-flex flex-row justify-content-start align-items-center">
                                                <a href="index.php?page=añadir-empleado">Añadir empleado</a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="pt-2">
        ...
        <div class="col-9 col-md-10 col-lg-11">
            <div class="row d-flex flex-row justify-content-end align-items-center">
                <div class="col-sm-3 col-lg-1 text-center">
