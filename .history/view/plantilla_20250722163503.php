    ...
    }else if ($vista != "inicio-sesion-view.php" && $vista != "registro-empresa-view.php"){
        include("view/includes/links.php");
        require("view/includes/registro-login-header.html");
        include("php/" . $vista);
        require("view/includes/registro-login-footer.html");
        include("view/includes/scripts.php");
    }
