...
class crudEmpleadoC extends mainModel
{
    ...
    //metodo para sanitizar campos validar
    public static function obtener_formulario($form): array
    {
        ...
        $form["empleado_tipo_deduccion"] = self::sanitizarTipoDeduccion($form["empleado_tipo_deduccion"]);
        ...
        $form["empleado_id_usuario"] = self::sanitizarIDEmpleado($form["empleado_id_usuario"]);
    ...
    private static function validarLuhn($numero)
    {
        $suma = 0;
    ...
    private static function sanitizarTipoPago($tipoPago)
    {
    ...
    private static function sanitizarBanco($banco)
    {
        if (!is_string($banco)) {
    ...
    private static function sanitizarNumeroCuenta($numeroCuenta)
    {
    ...
    private static function sanitizarUsuario($usuario)
    {
    ...
    private static function sanitizarContraseña($contraseña)
    {
    ...
    private static function validarCoincidenciaContraseñas($contraseña1, $contraseña2)
    {
    ...
    private static function sanitizarIDEmpleado($id)
    {
        if (!is_string($id)) {
