...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form): array
    {
        ...
        $horasSanitizadas = self::sanitizarHoras();
        $form["empleado_hora_entrada"] = self::sanitizarHoras($form["empleado_hora_entrada"], $form["empleado_hora_salida"])["hora_entrada"];
        $form["empleado_hora_salida"] = self::sanitizarHoras($form["empleado_hora_entrada"], $form["empleado_hora_salida"])["hora_salida"];
