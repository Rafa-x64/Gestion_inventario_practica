...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form): array
    {
        ...
        $form["empleado_fecha_nacimiento"] = date("Y-m-d", $form["empleado_fecha_nacimiento"]);
    ...
    private function sanitizarFechaNacimiento($fechaN){
        $empleado_fecha_nacimiento = $form["empleado_fecha_nacimiento"];
