...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form): array
    {
        ...
        return $form;//no retornar formulario, hacer metodo de registro en el modelo del empleado y ejecutarlo desde aqui (en caso de dar error acomodar los campos de la base de datos DATE, TIME)
    }
