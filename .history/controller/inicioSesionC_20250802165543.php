...
class inicioSesionC extends mainModel
{
    ...
    public static function validar_usuario($nombre_legal, $usuario, $contraseña): bool
    {
        ...
        try {
            ...
            if (!$datos || !isset($datos["contraseña_admin"])) {
                return false; // Usuario no encontrado o campo faltante
            }

            if (!seguridadM::verificar_contraseña($contraseña, $datos["contraseña_admin"])) {
