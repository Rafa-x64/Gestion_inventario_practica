...
class crudEmpleadoC extends mainModel
{
    ...
    private static function sanitizarTipoContrato($empleadoTipoContrato){
        ...
        if($empleadoTipoContrato != "tiempo completo" || $empleadoTipoContrato != "tiempo parcial" || $empleadoTipoContrato != "temporal" || $empleadoTipoContrato != "obra labor" || $empleadoTipoContrato != "prueba" || $empleadoTipoContrato != "indefinido" ||
    }
}
