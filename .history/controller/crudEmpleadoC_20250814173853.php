...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form): array
    {
        ...
        //sanitizar nombre
        $form["empleado_nombre"] = sanitizarNombre($form["empleado_nombre"]);
        //sanitizar cedula
        ...
        $form["empleado_fecha_nacimiento"] = sanitizarFechaNacimiento($form["empleado_fecha_nacimiento"]);
    ...
    {
        if(!is_string($nombre)){
            throw new InvalidArgumentException("el nombre debe ser una cadena ");")
        }
