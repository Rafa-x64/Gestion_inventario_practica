...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form)
    {
        ...
        $contraseña2 = self::sanitizarContraseña($form["empleado_contraseña2"]);
    ...
    public static function sanitizarIDEmpleado($id)
    {
        ...
        if (!preg_match('/^USR_[A-Z0-9]{6,10}$/', $id)) {
    ...
    public static function sanitizarIDEmpresa($id)
    {
        ...
        // Acepta EMP_ seguido de 6 a 10 caracteres alfanuméricos en mayúscula
        if (!preg_match('/^EMP_[A-Z0-9]{6,10}$/', $id)) {
