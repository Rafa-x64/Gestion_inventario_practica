...
class crudEmpleadoC extends mainModel
{
    ...
    public static function obtener_formulario($form)
    {
        ...
        $beneficiosAdicionales = self::sanitizarBeneficiosAdicionales($form["empleado_beneficios_adicionales"]);
        //sanitizar usuario
        ...
        //faltaron y id_empresa y beneficios adicionales

        $empleado = new empleadoM($id, $nombre, $cedula, $fechaNacimiento, $sexo, $telefono, $estadoCivil, $correo, $direccion, $rol, $fechaRegistro, $tipoContrato, $supervisor, $horaEntrada, $horaSalida, $estado, $salario, $bonificaciones, $motivoBonificacion, $tipoDeduccion, $montoDeduccion, $tipoPago, $banco, $numeroCuenta, $usuario, $contraseña, );
    ...
    {
        // Lista blanca de beneficios válidos
        $beneficiosValidos = [
            "ninguno",
            "seguro medico",
            "bono alimentacion",
        ...
        if (!is_array($beneficios)) {
            throw new InvalidArgumentException("Los beneficios deben enviarse como un arreglo");
        }
