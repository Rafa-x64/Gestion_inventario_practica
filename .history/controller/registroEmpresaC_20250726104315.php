...
class registroEmpresaC extends mainModel
{
    ...
    private static function encriptar_dato($dato): string //hacer un metodo desencriptar datos de la sesion en el controlador del dashboard para poder mostrar los datos del usuario
    {
