...
class registroEmpresaC extends mainModel
{
    ...
    public static function obtener_formulario($formulario, $imagen)
    {
        ...
        $contraseña_admin = parent::hashear_contraseña($contraseña); //contraseña hasheada
    ...
    {
        return strtoupper(substr(uniqid("EMP_"), 0, 12);
    }
    ...
    private static function guardar_datos_sesion($formulario)
    {
        foreach ($formulario as $key => $value) {
            $valor_encriptado = parent::encriptar_dato($value);
