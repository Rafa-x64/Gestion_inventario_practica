...
class inicioSesionC extends mainModel
{
    ...
    public static function validar_usuario($nombre_legal, $usuario, $contraseña): bool
    {
        ...
        try {
            ...
            $obtener->bindParam(":nombre_legal", $nombre_legal);
            $obtener->bindParam(":usuario", $usuario);
            $obtener->bindParam(":contraseña", $contraseña);
            $datos_empleado = $obtener->execute(PDO::FETCH_ASSOC);

            if(seguridadM::verificar_contraseña($contraseña, $datos_empleado["contraseña_ad"]));
