...
class crudEmpleadoC extends mainModel
{
    ...
    public static function sanitizarIDEmpresa($id)
    {
        ...
        if (!preg_match('/^EMP_[A-Z0-9]$/', $id)) {
            throw new InvalidArgumentException("El ID de la empresa debe tener el formato USR_ seguido de 8 caracteres alfanuméricos en mayúscula");
        }
