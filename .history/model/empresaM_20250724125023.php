...
class empresaM extends mainModel
{
    ...
    public function registrar_empresa(){
        $registrar = self::consulta("INSERT INTO empresa (id_empresa, nombre_legal, rif, direccion, contacto, correo, nombre_representante, fecha_registro, estado_condicion, logo, tipo_empresa, moneda, zona_horaria" values);
    }
