...
class empleadoM extends mainModel
{
    ...
    public function crearEmpleado(): bool {
        try{
            //primero acomodar la base de datos (revisar crud empleado en las lineas 412, 447, 529 y 618)
            //de todas maneras revisar el metodo obtener formulario y ver que campos faltan en la bd
