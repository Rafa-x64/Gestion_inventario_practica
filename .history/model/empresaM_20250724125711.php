...
class empresaM extends mainModel
{
    ...
    {
        $registrar = self::consulta("INSERT INTO empresa 
        (id_empresa, nombre_legal, rif, direccion, contacto, correo, nombre_representante, fecha_registro, estado_condicion, logo, tipo_empresa, moneda, zona_horaria values (?,?,?,?,?,?,?,?,?,?,?,?,?)");
        $registrar->execute([
            $this->id_empresa,
            $this->nombre_legal,
            $this->rif,
