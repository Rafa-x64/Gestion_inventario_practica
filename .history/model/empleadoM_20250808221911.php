...
class usuarioM extends mainModel
{
    ...
    private $nombre_empresa = "ninguno";
    ...
    public function obtener_formulario($formulario): array
    {
    ...
    public function setEmpresaId($nombre_empresa)
    {
        $this->nombre_empresa = $empresa_id;
    }
