...
class vistaM
{
    ...
    protected static function obtenerVista($pagina) //recive una variable pagina
    {
        ...
        $paginas_existentes = ["404", "inicio-sesion", "inicio", "registro-empresa", "dashboard-admin", "dashboard-empleado-admin", "dashboard-empleado-vendedor", "añadir-empleado-view"]; //lista de paginas del proyecto
